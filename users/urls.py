...
from users.views import UserRegistrationAPIView, UserUpdateAPIView, UserRetrieveAPIView, UserDestroyAPIView, \
    UserPasswordResetAPIView, UserPasswordResetConfirmAPIView
